# WSOPTV - PRD Overview (Deprecated)

> **Note**: 이 문서는 [00-master.md](./00-master.md)로 대체되었습니다.
> 아래 내용은 참조용으로 유지됩니다.

**Version**: 1.0.0 | **Status**: Deprecated | **Created**: 2025-12-17 | **Replaced**: 2025-12-20

---

## Executive Summary

WSOPTV는 **World Series of Poker(WSOP)** 콘텐츠를 전문으로 제공하는 글로벌 OTT 스트리밍 서비스입니다. **17.96TB (1,056개 파일), 1973-2025** 아카이브를 보유하고 있으며, 포커 팬들에게 최적화된 시청 경험과 포커 특화 기능으로 차별화된 가치를 전달합니다.
...
| 차별점 | 설명 |
|--------|------|
| **17.96TB 아카이브** | 1,056개 파일, 1973-2025 |
...
|-------------|------|------|
| **🔴 생방송** | 대회 실시간 스트리밍 | 실시간 |
| **풀 에피소드** | 1,056개 아카이브 (1973-2025) | 2~10시간+ |
...
| 기능 | 설명 |
|------|------|
| 모든 풀 에피소드 | 1,056개 아카이브 (1973-2025) |
...
**1973-2025 아카이브 (17.96TB, 1,056개 파일)**
